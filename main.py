...
def package_time_status(given_time, h_table, packages):  # time complexity: O(n)
...
def all_delivery_t1():  #  Time complexity: O(N)
    deliveries_t1 = delivery(truckone, address_list, distance_list, myhash)
    delivered_packages = deliveries_t1[3]
...
# function that loops through the delivery information of each package id and tells when it was delivered
def all_delivery_t2():  # Time complexity: O(N)
...
# function that loops through the delivery information of each package id and tells when it was delivered
def all_delivery_t3():  # Time complexity: O(N)
    deliveries_t3 = delivery(truckthree, address_list, distance_list, myhash)
...
def all_deliveries():  # Time complexity is O(n) * O(n) * O(n) = O(n^3)
    all_delivery_t1()
    all_delivery_t2()
    all_delivery_t3()
