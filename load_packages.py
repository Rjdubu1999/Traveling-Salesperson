...
trucktwo = delivery_truck.DeliveryTruck(16, .3, t2, "4001 South 700 East", 0.0, START, START)
truckthree = delivery_truck.DeliveryTruck(16, .3, t3, "4001 South 700 East", 0.0, START, START)
#print(truckone)
#print(trucktwo)
